...
public class State_XX implements State {
	private State_Machine machine;

	public State_XX(State_Machine machine) {
		this.setMachine(machine);
	}

	public void getNextState(String currentSymbol) {
		if (currentSymbol.equalsIgnoreCase("k")) {
			this.machine.setState(this.machine.getState_YY());
			System.out.println("Transitioned to K ");
